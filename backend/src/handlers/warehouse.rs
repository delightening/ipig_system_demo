...
pub async fn create_warehouse(
    ...
    require_permission!(current_user, "warehouse.create");
...
pub async fn list_warehouses(
    ...
    require_permission!(current_user, "warehouse.read");
...
pub async fn update_warehouse(
    ...
    require_permission!(current_user, "warehouse.update");
    req.validate().map_err(|e| AppError::Validation(e.to_string()))?;
...
pub async fn delete_warehouse(
    ...
    require_permission!(current_user, "warehouse.delete");
